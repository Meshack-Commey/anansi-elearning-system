        ...
        <>
           <section className="flex flex-col w-full">
                <div className='flex justify-between'>
                    <h1 className='text-xl text-slate-900 mb-5 capitalize'>Introduction to Financial Management </h1>
                    <Link href='/dashboard/fourth/bcom-marketing/current-slides/financial-management-slides'> Back</Link>
                </div>
                <div>
