...
// import anansiUrl from "./questions-pr.pdf"

export default function Read(){
    //const anansiUrl = require("./questions-pr.pdf");
    ...
    const anansiUrl = "https://anansi-elearning-files.onrender.com/questions-pr.pdf#toolbar=0"
        ...
        <>
           <section className="flex flex-col w-full">
                <div className='flex justify-between'>
                    ...
                    <Link href='/dashboard/fourth/bcom-marketing/past-questions/project-management-pasco'> Back</Link>
                </div>
                <div>
                    <iframe src={ anansiUrl } type="application/pdf" width="100%" height="600px" />
