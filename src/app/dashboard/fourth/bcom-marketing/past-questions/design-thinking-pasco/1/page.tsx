        ...
        <>
           <section className="flex flex-col w-full">
                <div className='flex justify-between'>
                    <h1 className='text-xl text-slate-900 mb-5 capitalize'> Design Thinking and Innovation </h1>
                    <Link href='/dashboard/fourth/bcom-marketing/past-questions/design-thinking-pasco'> Back</Link>
                </div>
                <div>
