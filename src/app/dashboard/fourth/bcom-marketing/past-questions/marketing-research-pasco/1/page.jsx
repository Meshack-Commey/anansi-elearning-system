        ...
        <>
           <section className="flex flex-col w-full">
                <div className='flex justify-between'>
                    <h1 className='text-xl text-slate-900 mb-5 capitalize'> Marketing Research </h1>
                    <Link href='/dashboard/fourth/bcom-marketing/past-questions/marketing-research-pasco'> Back</Link>
                </div>
                <div>
