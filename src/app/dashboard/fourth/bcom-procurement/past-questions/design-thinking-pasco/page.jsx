...
const courses = [
    {
        ...
        "published_year": 2023,
        "category": "thinking",
        "url": "/dashboard/fourth/bcom-procurement/past-questions/design-thinking-pasco/1"
    },
        ...
        <>
            <section className="flex flex-col w-full">
                <div className='flex justify-between'>
                    <h1 className='text-xl text-slate-900 mb-5'> Design Thinking and Innovation Past Questions </h1>
                    <Link href='/dashboard/fourth/bcom-procurement/past-questions'> Back</Link>
                </div>
