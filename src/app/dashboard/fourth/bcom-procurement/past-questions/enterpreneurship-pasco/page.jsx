...
const courses = [
    {
        ...
        "published_year": 2023,
        "category": "Management",
        "url": "/dashboard/fourth/bcom-procurement/past-questions/enterpreneurship-pasco/1"
    },
        ...
        <>
            <section className="flex flex-col w-full">
                <div className='flex justify-between'>
                    <h1 className='text-xl text-slate-900 mb-5'> Enterpreneurship Past Questions </h1>
