...
const courses = [
    {
        ...
        "published_year": 2023,
        "category": "methods",
        "url": "/dashboard/first/bcom-procurement/past-questions/business-statistics-pasco/1"
    },
        ...
        <>
            <section className="flex flex-col w-full">
                <div className='flex justify-between'>
                    <h1 className='text-xl text-slate-900 mb-5'> Business Statistics Past Questions </h1>
