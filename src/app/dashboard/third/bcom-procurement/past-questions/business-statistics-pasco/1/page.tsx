        ...
        <>
           <section className="flex flex-col w-full">
                <div className='flex justify-between'>
                    <h1 className='text-xl text-slate-900 mb-5 capitalize'> business statistics </h1>
                    <Link href='/dashboard/first/bcom-procurement/past-questions/business-statistics-pasco'> Back</Link>
                </div>
                <div>
