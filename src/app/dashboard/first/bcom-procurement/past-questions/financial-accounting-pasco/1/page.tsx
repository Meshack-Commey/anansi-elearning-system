        ...
        <>
           <section className="flex flex-col w-full">
                <div className='flex justify-between'>
                    <h1 className='text-xl text-slate-900 mb-5 capitalize'> Financial Accounting </h1>
                    <Link href='/dashboard/first/bcom-procurement/past-questions/financial-accounting-pasco'> Back</Link>
                </div>
                <div>
