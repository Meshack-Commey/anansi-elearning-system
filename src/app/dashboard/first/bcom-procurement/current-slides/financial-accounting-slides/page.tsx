...
const courses = [
    {
        ...
        "published_year": 2024,
        "category": "Lecture 1",
        "url": "/dashboard/first/bcom-procurement/current-slides/financial-accounting-slides/1"
    },
]
        ...
        <>
            <section className="flex flex-col w-full">
                <div className='flex justify-between'>
                    <h1 className='text-xl text-slate-900 mb-5'> Financial Accounting Slides </h1>
