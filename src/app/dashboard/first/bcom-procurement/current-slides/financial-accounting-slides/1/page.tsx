        ...
        <>
           <section className="flex flex-col w-full">
                <div className='flex justify-between'>
                    <h1 className='text-xl text-slate-900 mb-5 capitalize'> Introduction to Finanncial Accounting </h1>
                    <Link href='/dashboard/first/bcom-procurement/current-slides/financial-accounting-slides'> Back </Link>
                </div>
                <div>
