        ...
        <>
           <section className="flex flex-col w-full">
                <div className='flex justify-between'>
                    <h1 className='text-xl text-slate-900 mb-5 capitalize'> Introduction to Micro Economics </h1>
                    <Link href='/dashboard/first/bcom-procurement/current-slides/micro-economics-slides'> Back</Link>
                </div>
                <div>
