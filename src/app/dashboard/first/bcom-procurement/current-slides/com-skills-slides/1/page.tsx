        ...
        <>
           <section className="flex flex-col w-full">
                <div className='flex justify-between'>
                    <h1 className='text-xl text-slate-900 mb-5 capitalize'> Introduction to Communication Skills </h1>
                    <Link href='/dashboard/first/bcom-procurement/current-slides/com-skills-slides'> Back</Link>
                </div>
                <div>
