...
import { FullSideNav, ShortSideNav } from '@/components/SideBar'
    ...
    <>
        ...
        <header className='w-full h-16 bg-blue-900 flex justify-between fixed z-50'> 
                ...
                <section className='w-3/12 h-16 mr-8 p-2 bg-white text-blue-900 flex gap-2 justify-center'>
                    ...
                    <p className="text-base"> <span className='font-bold'>Kelly Yeboah </span><br /> <Link href={'/'}><span className='text-md'>Logout</span></Link> </p>
                </section>
            </header>
