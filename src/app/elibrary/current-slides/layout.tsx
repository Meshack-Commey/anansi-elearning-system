        ...
        <div className='p-14 pt-20 flex w-full gap-5'>
            <header className='w-2/12 flex flex-col gap-5'>
                ...
                <nav className="w-full flex flex-col justify-center items-center gap-8 bg-white text-blue-900 font-bold pt-4 pb-4">
                    <Link href={"/elibrary/current-slides/100"}>
                        <h1>Level 100</h1>
                    </Link>
                    <Link href={"/elibrary/current-slides/200"}>
                        <h1>Level 200</h1>
                    </Link>
                    <Link href={"/elibrary/current-slides/300"}>
                        <h1>Level 300</h1>
                    </Link>
                    <Link href={"/elibrary/current-slides/400"}>
                        <h1>Level 400</h1>
                    </Link>
                    {/* <Link href={"/elibrary/current-slides/others"}>
                        <h1>Others</h1>
                    </Link> */}
                </nav>
