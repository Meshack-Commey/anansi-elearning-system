        ...
        <>
            ...
            <header className='w-full h-14 pl-5 pr-10 bg-blue-900 flex justify-between fixed z-50'> 
                ...
                <nav className="flex gap-8 text-white pt-4">
                    ...
                    <Link href={"/elibrary/past-questions"}>
                        <h1>Past Questions</h1>
                    </Link>
                    <Link href={"/elibrary/current-slides"}>
                        <h1>Current Slides</h1>
                    </Link>
                    <Link href={"/elibrary/academic-timetable"}>
                        <h1>Academic Timetable</h1>
                    </Link>
                    <Link href={"/elibrary/contact-us"}>
                        <h1>Contact us</h1>
                    </Link>
                </nav>
                <Link href={"/"}>
                    <button className="w-18 p-2 mt-2 bg-white text-blue-900 font-bold border rounded">Log in</button>
                </Link>
            </header>
            {/** Endblock of Navbar Section */}
            <main className="w-full bg-inherit h-full">
                { children }
            </main>
